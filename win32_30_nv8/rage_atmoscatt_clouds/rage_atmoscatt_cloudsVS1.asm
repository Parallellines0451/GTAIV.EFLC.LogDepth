...
//
    ...
    add r0, r0, c11
    rcp r1.z, c76.x
    mad o1.z, r0.z, -r1.z, c5.x
    mul r1.z, r0.z, r1.z
    mov o0.z, r1.z
	mov o10.z, r1.z
    mul_sat r1.y, r1.y, c68.x
    mad r1.x, r1.x, c5.y, c5.y
    add r1.y, -r1.y, c5.x
    mul r1.y, r1.y, c71.x
    mov r2.xyz, c67
    add r2.xyz, -r2, c66
    ...
    dp3 r0.w, r0, r0
    rsq r0.w, r0.w
    mad r0.z, r0.z, r0.w, c5.x
    mul r0.xy, r0.w, r0
    rcp r0.z, r0.z
    mul r0.xyz, r0.z, r0.xyxw
    mad o0.xyw, r0.xyzz, c12.xyzz, c12.wzzy
	mad o10.xyw, r0.xyzz, c12.xyzz, c12.wzzy
    mov o1.xy, v1
