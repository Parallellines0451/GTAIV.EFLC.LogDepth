...
//
    ...
    ps_3_0
    def c219, 1.8395173895e+25, 3.9938258725e+24, 4.5435787456e+30, 8.6600245095e-43 // 618
    ...
    max r15, r14, c3.x
    mul r14, r15, r15
    mad r14, r14, r14, c6.z
    mul r15, r14, c6.w
    cmp r14, r14, r15, c3.x
    mul r10, r10, r14
    rsq r14.x, r13.x
    rsq r14.y, r13.y
    rsq r14.z, r13.z
    ...
    add r0.w, r0.w, r0.w
    rcp r0.w, r0.w
    mad r2.xy, r5, r0.w, -c0.y
    mul_sat r0.w, r5.z, c3.y
    add r2.xy, -r2, c0.x
    mov r2.zw, c3.x
    texldl r2, r2, s4
    mul r2.xyz, r0.w, r2
...
// approximately 303 instruction slots used (17 texture, 286 arithmetic)
