// c227 is a custom register that contains near and far clip values because the game randomly overwrites the NearFarPlane register with incorrect values in this shader
